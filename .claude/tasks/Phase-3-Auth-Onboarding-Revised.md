  ...
  return (
    <div className="min-h-screen p-6">
      ...
      <div className="max-w-md mx-auto text-center mt-20">
        <p className="text-gray-600 mb-6">Tu n'as aucune tâche pour le moment</p>
        <a
          href="/backlog"
          className="inline-block px-6 py-3 bg-black text-white font-bold border-2 border-black hover:bg-white hover:text-black"
        >
